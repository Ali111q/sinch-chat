...
export class Reg_type_view extends Component {
  ...
  render() {
    ...
    return(
        ...
        <span class="add-name-sing">
            <p>{}</p>
            <input type="text"  id=""  placeholder="اسم المستخدم "/>
        </span>
        ...
        <span class="cand">
            <h1>الجنس</h1>
            <select placeholder="الجنس" name="cars" id="cars">
        ...
        <span class="cand">
            <h1>المدينة</h1>
            <select placeholder="المدينة" name="cars" id="cars">
