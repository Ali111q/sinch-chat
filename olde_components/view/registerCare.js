...
export class registerCare extends Component {
  render() {
    return (
    <>
     <div class="father-sing">
        ...
        <span class="add-name-sing">
            <p>الاسم الكامل</p>
            <input type="text" placeholder="اسم المستخدم " name="name" id=""/>
        </span>
        <span class="add-name-sing">
            <p> اسم العيادة</p>
        ...
        <span class="cand">
            <h1> تخصص الرعاية الصحية</h1>
            <select value="الجنس" name="cars" id="cars">
                <option value="ذكر"> تخصص الرعاية الصحية</option>
