...
export class MobRequest extends Component {
  render() {
    return (
      <>
    <div className="grandmother">
        <div className="request-body">
            <div className="body-prof-img">
                <img src="../seting/lady.png" alt=""/>
        </div>
            <div className="body-request-info">
                ...
                <span className="phon">
                    <h2>رقم الهاتف</h2>
                    <span>
                        <input type="number" value="ادخل رقم الهاتف"/>
                        <button>
                            <h2 className="key">+964</h2>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="8.771vw"height="5.911vw" viewBox="0 0 54.771 37.911">
                                <defs>
                ...
                <button className="send-rq">ارسال</button>
            </div>
