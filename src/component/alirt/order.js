    ...
    <>
      {isPC ? (
        <div className="request-alert2233">
          ...
          <h2>الحجزات و الاستشارات</h2>
          <div className="sher-alert-list11" id="style1">
                            ...
                            >
                              <div className="sher-us-data">
                                <span className="sher-us-data-img">
                                  <img src={r.received_obj.image} alt="" />
                                </span>
                                <span className="sher-us-data-name">
                                  <h3>{r.received_obj.user_name}</h3>
                                  <p>{r.received_obj.account_type_name}</p>
                                </span>
                              </div>
                              <button
                                onClick={() => {
                                  setpath(`/ViewMyReq/${r.id}`);
                                }}
                                style={{
                                  width: "fit-content",
                                  font: "2vw",
