...
function AddPost(props) {
  ...
  function handlePost() {
    ...
    // .post(`${url}/home/posts/store`, formData, {
      console.log("post");
    axios
      .post(`http://45.35.7.88:3000/upload`, formData, {
        headers: { Authorization: `Bearer 532|8gvKoYuYGEobza3PaTtrYM1kKZvoMbYlEDGmzjGl`},
      })
      .then((result) => {
        console.log(result);
        ...
        <AppBar run={props.run} />
          <div  className="addNewPost">
            ...
            <div className="AddList">
              <ul>
                <li id={selcted==0?"":"AddListulli"}
                 onClick={e=>{
                  setselcted(0)
                }}>منشور</li>
              {localStorage.getItem("type") != 1 && (
                <li
                  id={selcted == 1 ? "" : "AddListulli"}
                  onClick={(e) => {
                    setselcted(1);
                  }}>
                  جهز اعلانك
